...
<body>
		...
		<a class="navi_link" href="<%=Pages.CONTROL%>.html"><img <%= Pages.CONTROL.equals(pg) ? "style='display:none;'" : "" %> src='resources/control.png'><img <%= Pages.CONTROL.equals(pg) ? "" : "style='display:none;'" %> src='resources/control-hover.png' ></a>
